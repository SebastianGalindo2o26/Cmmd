...
/** @typedef {{ id: number, mesa_id: number, usuario_id: number, correlativo: number|null, fecha_correlativo: string|null, estado: EstadoOrden, total: string, items: ItemOrden[], pagos: Pago[] }} Orden */
